...
// const PrivateRoute = ({ children }) => {
//   const isAuthenticated = localStorage.getItem('token');
//   return isAuthenticated ? children : <Navigate to="/auth" />; // Use Navigate to redirect
// };

// const AdminPrivateRoute = ({ children }) => {
//   const isAdminAuthenticated = localStorage.getItem('admin-token');
//   return isAdminAuthenticated ? children : <Navigate to="/admin/login" />; // Use Navigate to redirect
// };
...
//           <Route path="/transportation" element={<Transportation />} />
//           <Route path="/private-transfers" element={<PrivateRoute><PrivateTransferForm /></PrivateRoute>} />
//           <Route path="/bicycle-rentals" element={<PrivateRoute><BicycleRentals /></PrivateRoute>} />
//           <Route path="/admin/login" element={<AdminAuth />} />
//           <Route path="/admin/panel" element={<AdminPrivateRoute><AdminPanel /></AdminPrivateRoute>} />
//         </Routes>
//       </div>
//     </Router>
//   );
